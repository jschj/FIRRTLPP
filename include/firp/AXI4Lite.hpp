...
std::vector<firp::FValue> axi4LiteRegisterFile(const AXI4LiteConfig& cfg, const std::vector<std::string>& registers, uint32_t regOffset, firp::FValue axi4LiteSlave);
